...
<nav id="secondary">
    <ul>
		...
		<li class="active"><a href="sub.php">Subjectivity Analysis</a></li>
...
echo '<h2 class="output">Subjectivity Analysis</h2>';
echo '<pre>';
//print_r($DocumentClassification);
if($DocumentClassification['SubjectivityAnalysis']=='subjective')
echo "Subjective Content";
else if($DocumentClassification['SubjectivityAnalysis']=='objective')
echo "Objective Content";
echo '</pre>';
