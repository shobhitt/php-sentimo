...
<nav id="secondary">
    <ul>
		...
		<li class="active"><a href="topic.php">Topic Classification</a></li>
		...
		<li><a href="gender.php">Gender Detection</a></li>
    </ul>
</nav>
<div class="box">
    <div class="box-header">
        <h1>Topic Classification</h1>
    </div>
...
echo '<h2 class="output">Topic Classification</h2>';
echo '<pre>';
//print_r($DocumentClassification);
//echo json_encode($DocumentClassification);
$value = array_shift($DocumentClassification);
echo $value;
/*if($DocumentClassification['TopicClassification']=='neutral')
echo "Neutral";
else if($DocumentClassification['TopicClassification']=='positive')
echo "Positive";
else if($DocumentClassification['TopicClassification']=='negative')
echo "Negative";
echo '</pre>';
*/
}
