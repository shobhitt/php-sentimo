...
<nav id="secondary">
    <ul>
		...
		<li class="active"><a href="comm.php">Commercial Detection</a></li>
...
echo '<h2 class="output">Commercial Detection</h2>';
echo '<pre>';
//print_r($DocumentClassification);
if($DocumentClassification['CommercialDetection']=='noncommercial')
echo "Non-Commercial Content";
else if($DocumentClassification['CommercialDetection']=='commercial')
echo "Commercial Content";
echo '</pre>';
