...
<nav id="secondary">
    <ul>
		...
		<li class="active"><a href="adult.php">Adult Content Detection</a></li>
...
echo '<h2 class="output">Adult Content Detection</h2>';
echo '<pre>';
//print_r($DocumentClassification);
if($DocumentClassification['AdultContentDetection']=='noadult')
echo "No Adult Content";
else if($DocumentClassification['AdultContentDetection']=='adult')
echo "Adult Content";
echo '</pre>';
