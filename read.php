...
<nav id="secondary">
    <ul>
		...
		<li class="active"><a href="read.php">Readability Assessment</a></li>
...
echo '<h2 class="output">Readability Assessment</h2>';
echo '<pre>';
//print_r($DocumentClassification);
if($DocumentClassification['ReadabilityAssessment']=='basic')
echo "Basic Level";
else if($DocumentClassification['ReadabilityAssessment']=='intermediate')
echo "Intermediate Level";
else if($DocumentClassification['ReadabilityAssessment']=='advanced')
echo "Advanced Level";
echo '</pre>';
