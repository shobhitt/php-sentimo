...
<nav id="secondary">
    <ul>
		...
		<li class="active"><a href="spam.php">Spam Detection</a></li>
...
echo '<h2 class="output">Spam Detection</h2>';
echo '<pre>';
//print_r($DocumentClassification);
if($DocumentClassification['SpamDetection']=='nospam')
echo "No Spam Content";
else if($DocumentClassification['SpamDetection']=='spam')
echo "Spam Content";
echo '</pre>';
