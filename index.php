...
<nav id="secondary">
    <ul>
        <li class="active"><a href="index.php">Sentiment Analysis</a></li>
...
echo '<h2 class="output">Sentiment Classification</h2>';
echo '<pre>';
//print_r($DocumentClassification);
if($DocumentClassification['SentimentAnalysis']=='neutral')
echo "Neutral";
else if($DocumentClassification['SentimentAnalysis']=='positive')
echo "Positive";
else if($DocumentClassification['SentimentAnalysis']=='negative')
echo "Negative";
echo '</pre>';
