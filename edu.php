...
<nav id="secondary">
    <ul>
		...
		<li class="active"><a href="edu.php">Educational Detection</a></li>
		<li><a href="gender.php">Gender Detection</a></li>
    </ul>
</nav>
<div class="box">
    <div class="box-header">
        <h1>Educational Detection</h1>
    </div>
...
echo '<h2 class="output">Educational Content Detection</h2>';
echo '<pre>';
//print_r($DocumentClassification);
if($DocumentClassification['EducationalDetection']=='noneducational')
echo "Non Educational Content";
else if($DocumentClassification['EducationalDetection']=='educational')
